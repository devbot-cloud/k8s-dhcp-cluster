...
// +kubebuilder:rbac:groups=dhcp.lootbot.cloud,resources=dhcphosts,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dhcp.lootbot.cloud,resources=dhcphosts/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=dhcp.lootbot.cloud,resources=dhcphosts/finalizers,verbs=update
